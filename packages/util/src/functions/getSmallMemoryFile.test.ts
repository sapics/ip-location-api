...
describe('getSmallMemoryFile', () => {
  ...
  it('should work with different database configurations', () => {
    ...
    expect(result).toEqual(['v6/_1', '_5', 5540])
  })
})
